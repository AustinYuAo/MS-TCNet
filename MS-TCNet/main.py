...
from trainer_brat import run_training_brat

from networks.mstcnet_acdc import mstcnet as mstcnet_acdc
from utils.data_utils_acdc import get_loader_acdc
from trainer_acdc import run_training_acdc 

from optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR
from functools import partial
import argparse

parser = argparse.ArgumentParser(description='mstcnet segmentation pipeline')
parser.add_argument('--checkpoint', default=None, help='start training from saved checkpoint')
parser.add_argument('--logdir', default='test', type=str, help='directory to save the tensorboard logs')
parser.add_argument('--pretrained_dir', default='./pretrained_models/', type=str, help='pretrained checkpoint directory')
parser.add_argument('--data_dir', default='/dataset/dataset0/', type=str, help='dataset directory')
parser.add_argument('--json_list', default='dataset_0.json', type=str, help='dataset json file')
parser.add_argument('--pretrained_model_name', default='model.pth', type=str, help='pretrained model name')
...
def main_worker(gpu, args):
    ...
    elif (args.model_name is None) or args.model_name == 'mstcnet_brats':
        print("mstcnet_brats")

        loader = get_loader_brats(args)
    ...
    elif (args.model_name is None) or args.model_name == 'mstcnet_acdc':
        print("mstcnet_acdc")
    ...
    if args.model_name == "mstcnet_brats":
        dice_loss = DiceCELoss(to_onehot_y=False,
                           sigmoid=True,
                           squared_pred=True,
                           smooth_nr=args.smooth_nr,
                           smooth_dr=args.smooth_dr)
    ...
    if args.model_name == 'mstcnet_btcv':
        accuracy = run_training_btcv(model=model,
                                ...
                                post_pred=post_pred)
    elif args.model_name == "mstcnet_brats":
        accuracy = run_training_brat(model=model,
                        train_loader=loader[0],
                        val_loader=loader[1],
                        optimizer=optimizer,
                        loss_func=dice_loss,
    ...
    elif args.model_name == 'mstcnet_acdc':
        accuracy = run_training_acdc(model=model,
                                train_loader=loader[0],
                                val_loader=loader[1],
                                optimizer=optimizer,
                                loss_func=dice_loss,
